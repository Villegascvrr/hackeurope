      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <ScrollReveal>
          <div className="mb-20">
            ...
            <h2 className="mb-5 max-w-3xl">Unified Risk Architecture</h2>
          ...
          <ScrollReveal delay={0.1}>
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <div className="card-brutal-sm card-hover rounded-2xl p-4 text-center flex-1 bg-card">
              ...
              <div className="card-brutal-primary card-hover rounded-2xl p-6 text-center bg-accent">
            ...
            <div className="space-y-0">
              {bullets.map((item, i) => (
                <StaggerItem key={i} index={i}>
                  <div className="flex items-start gap-5 py-5 border-b-2 border-border last:border-0">
