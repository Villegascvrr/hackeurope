    ...
    <section className="py-24 lg:py-32 border-t border-border/50">
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <p className="text-sm font-medium text-primary mb-3 tracking-wide uppercase">Technical Differentiation</p>
          ...
          <div className="space-y-4">
            {differentiators.map((item, i) => (
              <div key={i} className="flex items-start gap-4 p-4 rounded-lg border border-border bg-card card-elevated hover:border-primary/20 transition-colors duration-300">
                <span className="mono text-xs text-primary font-medium mt-0.5">0{i + 1}</span>
